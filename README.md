...
这是一个横屏微信小游戏 Canvas 项目，当前已从官方射击模板改造成单机上大人花牌游戏。玩法采用可配置的本地默认规则：四方座位、一名真人玩家、三名本地 AI、8 句话共 24 个牌字，每字 6 张，共 144 张牌；流程包含滑庄、接庄、摸牌、出牌、吃、碰、招、踏、胡、进圈、流局和重新开局。
...
- AI 会自动处理接庄、摸牌、响应弃牌、选择出牌，并保留短暂思考提示。
...
├── scripts
│   └── run-huapai-checks.mjs     // 本地规则/布局验证脚本
├── game.js                       // 小游戏入口
